...
TaoString string("string", TaoPitch(100.000f, TaoPitch::frq), 30.0000f);
...
void taoScore() {
  ...
  if (Tick <= (long)((tao.newEnd = tao.start * 1.00000 + 0.000100000f) *
    ...
    string(0.900000f).applyForce(1.00000f);
    tao.popStartAndEnd();
  }

  out1.chL(string(0.100000f));
  out1.chR(string(0.900000f));
  out2.ch1(string(0.500000f));
