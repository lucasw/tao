//////////////////////////////////////////////////////////////////////////////////
// This is the translated version of script "rectangle2.tao".
//
...
TaoRectangle rectangle2("rectangle2", TaoPitch(150.000f, TaoPitch::frq),
                        TaoPitch(800.000f, TaoPitch::frq), 20.0000f);
...
void taoScore() {
  ...
  if (Tick <= (long)((tao.newEnd = 0.00100000) *
    ...
    rectangle2(0.100000f, 0.100000f)
...
// End of C++ program generated from script "rectangle2.tao"
