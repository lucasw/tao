...
enum {
  ...
  AF_ERR_BAD_ACCMODE =
      10 + AF_ERR_BASE, /* unrecognized audio file access mode */
  ...
  AF_ERR_BAD_NUMTRACKS =
      25 + AF_ERR_BASE, /* wrong number of tracks for file format */
  ...
  AF_ERR_BAD_INSTPTYPE =
      51 + AF_ERR_BASE,                  /* invalid instrument parameter type */
  AF_ERR_BAD_INSTPID = 52 + AF_ERR_BASE, /* invalid instrument parameter id */

  AF_ERR_BAD_BYTEORDER = 53 + AF_ERR_BASE,
  AF_ERR_BAD_FILEFMT_PARAM =
      54 + AF_ERR_BASE, /* unrecognized file format parameter */
  AF_ERR_BAD_COMP_PARAM =
      55 + AF_ERR_BASE, /* unrecognized compression parameter */
  ...
  AF_ERR_BAD_AIFF_CHUNKID =
      69 + AF_ERR_BASE, /* unrecognized AIFF/AIFF-C chunk id */
  ...
  AF_ERR_BAD_AIFF_SKIP =
      73 + AF_ERR_BASE, /* failed to skip unsupported chunk */
  AF_ERR_BAD_AIFF_LOOPMODE =
      74 + AF_ERR_BASE /* unrecognized loop mode (forw, etc) */
};
